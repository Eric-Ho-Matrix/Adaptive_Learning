...
class def_ps:
    def __init__(self, std):
        ...
        self.noise_sd        = std;         # Emission noise in bin units
...
# def get_beliefs(data, beliefs, stdv, newB):
def get_beliefs(data, beliefs, std):

    # initializations
    ps = def_subj_params(std)
