...
This is the basic LEIA changepoint model, which we use asymetrical connectivity to push attractor state transition 
...
plt.title('LEIA Changepoint Model Prediction', fontsize=20)
